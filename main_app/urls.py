...
urlpatterns = [
    ...
    path('staff/get_students_for_noc/', staff_views.get_students_for_noc, name='get_students_for_noc'),
...
#     path('sign_enoc/<int:student_id>/<int:subject_id>/', staff_views.sign_enoc, name='sign_enoc'),
    path('staff/student_noc_details/<int:student_id>/', staff_views.student_noc_details, name='student_noc_details'),
